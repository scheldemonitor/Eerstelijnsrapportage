...
* Eindversie 22-02-2023: bevat data t/m `r dataJaar`, missend in deze versie is:
  ...
  + Biota hoofdstuk niet toegevoegd. Niet genoeg data beschikbaar uit Scheldemonitor.
  
* Concept versie 16-03-2021: bevat data t/m `r dataJaar`, missend in deze versie is:
  + Golven: locatie Cadzand, 
  + Biota: De gegevens over verontreinigingen in biota zijn op dit moment onvolledig of ontbrekend. Besloten is om deze voorlopig weg te laten uit de eerstelijnsrapportage. 

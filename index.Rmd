...
cover-image: Figuren/cover/getijdenland.jpg
# documentclass: book
bibliography: bib/westerschelde.bib
biblio-style: apalike # alleen voor natbib
link-citations: yes   # alleen voor natbib
...
```{r conditional_summary, eval = knitr::is_html_output(), results='asis', echo =FALSE}

cat(
  c(
    "## Samenvatting {}",
    paste("Deze rapportage is opgemaakt met door RWS in de Scheldemonitor beschikbaar gemaakte hydrodynamische, fysisch-chemische en biologische gegevens (alleen fytoplankton). De rapportage gaat over gegevens verzameld in de periode 1996 tot en met", dataJaar, "voor de Westerschelde en de monding. De gegevens zijn verkregen in het kader van de Nederlandse MWTL monitoring. Het is een eerste weergave van de beschikbare data en heeft als doel om enkel te beschrijven ‘wat men in de meetresultaten ziet’. Het bevat een korte interpretatie van de gegevens op basis van een eenvoudige analyse."),
    paste("Deze rapportage is opgemaakt met door RWS in de Scheldemonitor beschikbaar gemaakte hydrodynamische, fysisch-chemische en biologische gegevens (alleen fytoplankton). De rapportage gaat over gegevens verzameld in de periode 1996 tot en met", dataJaar, "voor de Westerschelde en de monding. De gegevens zijn verkregen in het kader van de Nederlandse MWTL monitoring. Het is een eerste weergave van de beschikbare data en heeft als doel om enkel te beschrijven ‘wat men in de meetresultaten ziet’. Het bevat een korte interpretatie van de gegevens op basis van een eenvoudige analyse."),
...
```{r conditional, eval = !draft, results = 'asis', echo = FALSE}
cat(
  paste0(
    "Deze rapportage is de definitieve versie 2024, gemaakt op ", 
    lubridate::today(), 
    ". Het bevat gegevens tot en met ", 
    dataJaar, 
    "."
    )
  ) 
...
## Veranderingen ten opzichte van de vorige rapportages

De volgende veranderingen zijn toegepast ten opzichte van de vorige versie:

1. De gegevens voor korrelgrootte in bodem/sediment zijn toegevoegd in zoverre beschikbaar

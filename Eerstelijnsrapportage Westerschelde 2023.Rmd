...
plotTrendsWaterstand(df_waterstanden, c("Hoogwater in cm+NAP","Laagwater in cm+NAP"), "Europlatform")
...
HW <- stationMedian(df_waterstanden, "Hoogwater in cm+NAP")
LW <- stationMedian(df_waterstanden, "Laagwater in cm+NAP")

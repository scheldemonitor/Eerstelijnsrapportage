...
1) data download van Scheldemonitor met R script. 
2) geen lokaal datamanagement voor data uit Scheldemonitor. De gedownloade data worden wel als csv bestanden opgeslagen voor consistentie tijdens het maken van de rapportage.
3) Verwerking van data tot rapport met Rmarkdown. Dit combineert code met beschrijvende tekst. De uitvoer in dit geval is een website. Ook kan er een pdf uitvoer gemaakt worden. 

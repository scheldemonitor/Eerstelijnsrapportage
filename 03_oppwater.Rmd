...
verifyStations <- function(df) {
  if(df %>% filter(parametername == parname) %>% distinct(stationname) %>% right_join(tibble(stationname = trendstations))  %>% nrow() == 6) df2 <- df <- df %>% 
...
df <- df %>% 
  filter(stationname %in% c(trendstations, extrastations)) %>% 
  mutate(stationname = factor(stationname, levels = c(trendstations, extrastations))) %>%
  # repair_limits() %>%
  group_by(parametername, stationname) %>%
  mutate(across(value, remove_outliers)) %>%
...
knitr::kable(dt, 
             ...
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van saliniteit (DIMSLS) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996."
             )
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van temperatuur (oC) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 2000.")
```
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van zuurstof (\\%) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van zuurstof (mg/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van chlorofyl-a (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 2000")
```
...
De mediane waardes zijn relatief laag (ca. 2 - 5 $\mu g/l$) en schommelen wat over de tijd. De jaarlijkse 90-percentielen laten een grote variatie zien. Bij Schaar van Ouden Doel zijn de 90-percentielen in de periode 2007-2014 hoger dan in de andere jaren. Over de gehele gegevensset constateren we geen significante statistische veranderingen, behalve op stations Vlissingen, waar een toename is, en in Walcheren 20km uit de kust, waar een significante afname lijkt te zijn over de tijd.

```{r fysischChlorofylJaar, fig.cap="Jaarlijkse mediaan, 10- en 90-percentiel van chlorofyl-a in het oppervlaktewater van de Westerschelde en de monding. De y-as is log-getransformeerd."}
...
#              caption = "mediaan, 10- en 90-percentiel waardes van feofytine in $\\mu$ g/L in het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van feofytine-a (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
Voor het station Schaar van Ouden doel zijn slechts enkele waarnemingen in 1996 en 1997 beschikbaar en dat station is daarom niet opgenomen in deze rapportage. De stations zijn gerangschikt in stroomafwaartse richting. In stroomafwaartse richting neemt de hoeveelheid feofytine-a af, zie Figuur \@ref(fig:gemiddeldfeofytine). Ook lijken op Hansweert en Terneuzen de gehaltes feofytine-a licht af te nemen in de tijd. Specifiek voor Terneuzen neemt de hoeveelheid feofytine af met 0.005 $\mu$ g/L per jaar met enige significantie.

```{r fysischFeofytineJaar, fig.cap="Jaarlijkse mediaan, 10- en 90-percentiel van feofytine in het oppervlaktewater van de Westerschelde en de monding. Statistiek is uitgevoerd op log-getransformeerde gegevens. De y-as is log-getransformeerd."}
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het chemisch zuurstofverbruik in mg/L in het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van chemisch zuurstofverbruik (mg/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
```{r gemiddeldchemischzuurstof, fig.cap="Mediaan van chemisch zuurstofverbruik per station berekend op alle beschikbare gegevens vanaf 2001."}
...
#              caption = "mediaan, 10- en 90-percentiel waardes van het biochemisch zuurstofverbruik in mg/L in het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van biochemisch zuurstofverbruik (mg/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van doorzicht (dm) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 2000.")
```
...
```{r fysischDoorzicht, fig.cap="Jaarlijkse mediaan, 10- en 90-percentiel van het doorzicht (dm) in het oppervlaktewater van de Westerschelde."}
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van de extinctiecoëfficiënt in $m^{-1}$ van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van lichtextinctie (1/m) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
#              caption = "mediaan, 10- en 90-percentiel waardes van de hoeveelheid zwevende stof in mg/L in het het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van zwevend stof (mg/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
```{r fysischZwevendeStof, fig.cap="Jaarlijkse mediaan, 10- en 90-percentiel van de hoeveelheid zwevende stof in het oppervlaktewater van de Westerschelde en de monding."}
...
Stikstof komt in het oppervlaktewater voor in verschillende vormen: \* anorganisch: + ammonium ($NH_4^+$); + nitriet ($NO_2^-$); + nitraat ($NO_3^-$); \* organisch (meestal gemeten samen met ammonium als 'Kjeldahl-stikstof'): + opgelost, bv. in de vorm van humuszuren; + particulair, bv. materiaal afkomstig van lozingen of van algengroei.
...
Fosfor komt in het oppervlaktewater in de volgende vormen voor: \* anorganisch + orthofosfaat (opgelost, o-$PO_4^{3-}$); + gebonden aan slib \* organisch + opgelost, bv. in de vorm van humuszuren; + particulair, bv. materiaal afkomstig van lozingen of van algengroei.
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van het opgelost stikstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt, 
             ...
             caption = "Mediaan, 10-percentiel en 90-percentiel  en de trend en p waarde van de trend van het particulair stikstofgehalte in mg/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt,
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van molaire genormaliseerde N-C-ratio van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")

dt <- statTable(dfm, parname = `TPN/POC`, rounding)
knitr::kable(dt,
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van molaire genormaliseerde P-C-ratio van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")

dt <- statTable(dfm, parname = `TPN/TPP`, rounding)
knitr::kable(dt,
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van molaire genormaliseerde N-P-ratio van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
Metalen in het oppervlaktewater worden zowel voor als na filtratie gemeten. Voor de volgende metalen in het oppervlaktewater worden de metingen gepresenteerd: \* Boor (B) \* Chroom (Cr) \* Koper (Cu) \* Uranium (U) \* Vanadium (V) \* Zink (Zn)
...
```{r metalenSaliniteitPlot, fig.height=8, fig.cap=" De concentratie van gemeten metalen uitgezet tegen de gemeten Saliniteit op dezelfde dag."}
df2 %>% 
  ...
  group_by(datetime, stationname, parametername) %>% summarize(value = mean(value)) %>%
  # mutate(jaar = year(datetime), maand = month(datetime)) %>%
  # group_by(stationname, jaar, maand, parametername) %>%
  mutate(parametername = str_replace(parametername, " in oppervlaktewater", "")) %>%
  # summarize(value = median(value), .groups = 'drop') %>%
  pivot_wider(names_from = parametername, values_from = value, id_cols = c(datetime, stationname)) %>%
  pivot_longer(-c(datetime, stationname, `Saliniteit in PSU`), names_to = "parametername") %>%
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale boorgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van boor (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van boor na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale chroomgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van chroom (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het gefilterde chroomgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van chroom na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale kopergehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van koper (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het gefilterde kopergehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van koper na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale uraniumgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van uranium (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het gefilterde uraniumgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van uranium na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale vanadiumgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van vanadium (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum","Trend","R"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het gefilterde vanadiumgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van vanadium na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het totale zinkgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van zink (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```
...
# knitr::kable(dt, col.names = c("Station","Gemiddelde","Maximum","Minimum"),
#              caption = "mediaan, 10- en 90-percentiel waardes van het gefilterde zinkgehalte in $\\mu$g/L van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
...
knitr::kable(dt, 
             align = 'lrrrrr',
             caption = "Mediaan, 10-percentiel en 90-percentiel en de trend en p waarde van de trend van zink na filtratie (ug/l) van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1996.")
```

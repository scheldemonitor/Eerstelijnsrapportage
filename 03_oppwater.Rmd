...
knitr::kable(dt, 
             ...
             caption = "Statistiek voor saliniteit van het oppervlaktewater van de Westerschelde en de monding berekend op alle beschikbare gegevens vanaf 1998."
             )
...
De mediane waardes zijn relatief laag (ca. 2 - 5 $\mu g/l$) en schommelen over de tijd. Ook jaarlijkse 90- en 10-percentielwaardes laten een grote variatie zien. Over de gehele meetperiode constateren we een significante statistische lichte toename op station Vlissingen boei SSVH. Op de stations Hansweert geul, Terneuzen boei en Vlissingen boei nemen de mediane waards sinds 2021 af, dit zou te maken kunnen hebben met de geregistreerde toenenmende aantallen van de brakwatercorbula (*Potamocorbula amurensis*), een extische tweekleppige macroinvertebraat @Son2008. Bij Schaar van Ouden Doel is vooral tussen 2017 en 2021 een afname in Chlorofyl-a zichtbaar. 

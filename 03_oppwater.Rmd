...
```{r fysischDoorzicht, fig.height=5, fig.cap="Jaarlijkse mediaan, 10- en 90-percentiel van het doorzicht (dm) in het oppervlaktewater van de Westerschelde."}

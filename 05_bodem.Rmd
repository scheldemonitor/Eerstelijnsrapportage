...
## Korrelgrootteverdeling {#bodem-korrelgrootte}
...
-   korrelgroottefractie > 63 µm (Figuur \@ref(fig:korrelvanaf63Bodem))
-   korrelgroottefractie tot 63 µm (Figuur \@ref(fig:korreltot63Bodem))
-   korrelgroottefractie tot 16 µm (Figuur \@ref(fig:korreltot16Bodem))
-   korrelgroottefractie tot 2 µm (Figuur \@ref(fig:korreltot2Bodem))
...
Daarnaast is ook het percentage organisch koolstof meegenomen in deze rapportage (Figuur \@ref(fig:OrganischCBodem)). Dit percentage is bepaald middels katalytische oxidatie. 


```{r korrelvanaf63Bodem, fig.cap="Korrelgroottefractie > 63 µm in het bodemsediment in de Westerschelde"}
#knitr::include_graphics("Figuren/Fysisch/Bodem/korrelgroottegroter63um.png")

parname = "Korrelgroottefractie >63 um in % drooggewicht in bodem/sediment"

plotTrends(df_clean %>% 
             filter(datetime >= as.POSIXct("2013-01-01 00:00:00") &
                      datetime <= as.POSIXct("2022-12-31 23:59:59")), 
           parname, trend = F) + facet_wrap(~Station, ncol = 4)
```

```{r korreltot63Bodem, fig.cap="Korrelgroottefractie tot 63 µm in het bodemsediment in de Westerschelde"}
#knitr::include_graphics("Figuren/Fysisch/Bodem/korrelgroottetot63um.png")

parname = "Korrelgroottefractie tot 63 um in % drooggewicht in bodem/sediment"

plotTrends(df_clean, parname, trend = F) + facet_wrap(~Station, ncol = 4)
```

```{r korreltot16Bodem, fig.cap="Korrelgroottefractie tot 16 µm in het bodemsediment in de Westerschelde"}
#knitr::include_graphics("Figuren/Fysisch/Bodem/korrelgroottetot16um.png")

parname = "Korrelgroottefractie tot 16 um in % drooggewicht in bodem/sediment"

plotTrends(df_clean, parname, trend = F) + facet_wrap(~Station, ncol = 4)
```

```{r korreltot2Bodem, fig.cap="Korrelgroottefractie tot 2 µm in het bodemsediment in de Westerschelde"}
#knitr::include_graphics("Figuren/Fysisch/Bodem/korrelgroottetot2um.png")

parname = "Korrelgroottefractie tot 2 um in % drooggewicht in bodem/sediment"

plotTrends(df_clean, parname, trend = F) + facet_wrap(~Station, ncol = 4)
```

```{r OrganischCBodem, fig.cap="Percentage organisch koolstof in het bodemsediment in de Westerschelde"}
#knitr::include_graphics("Figuren/Fysisch/Bodem/OrganischKoolstof.png")

parname = "Organische koolstof in % drooggewicht in bodem/sediment"
...
parname = "Antraceen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Benzo(a)antraceen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Benzo(a)pyreen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Benzo(g,h,i)peryleen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Benzo(k)fluorantheen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Chryseen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Fenantreen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Fluorantheen in mg/kg drooggewicht in bodem/sediment"
...
parname = "Indeno(1,2,3-c,d)pyreen in mg/kg drooggewicht in bodem/sediment"

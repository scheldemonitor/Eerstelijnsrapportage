...
plotTrends(df_clean, parname, trend = F)
```

De hoeveelheid PCB's neemt af in de richting van de Noordzee. Met name bij de oostelijke stations lijken de gehaltes af te nemen in de tijd.%, hoewel de gehaltes in 2016 wel hoger zijn dan in 2013. <!-- %CHECK THIS STATEMENT! -->
...
plotTrendsWaterstand(df_clean, parname, locname = unique(df_clean$stationname)) + facet_wrap(~Station, ncol = 4)
```

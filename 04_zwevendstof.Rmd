...
```{r zwevendMetalen, fig.height=8, fig.cap="Trends voor alle hier behandelde metalen in mg/kg drooggewicht in zwevend stof."}
parname <- c(
   ...
   stats <- df %>%
    ...
    knitr::kables(
      list(
        ...
        knitr::kable(t2, align = "l", col.names = NULL)
...
```{r zwevendPAKs, fig.height=8, fig.width=8, fig.cap="Trends voor alle hier behandelde PAK's in mg/kg drooggewicht in zwevend stof."}
parname <- c(
...
Figuur \@ref(fig:zwevendPCBs) toont de jaarlijkse mediaan PCB180 per station voor de periode vanaf 1996 t/m `r dataJaar`, samen met de 10- en 90-percentiele waarde per jaar. Daarnaast zijn in Tabel \@ref(tab:zwevendPCBsTab) de mediane, 10- en 90-percentiele waardes per station weergegeven. Voor beide stations constateren we een afnemende lineaire trend rond de 0,06 tot 0,26 $\mu$g/kg per jaar. Voor station Vlissingen is deze afname minder groot dan voor station Schaar van Ouden Doel, maar deze trend heeft wel een hogere correlatie coëfficiënt.


### PCB138 {#zwevend-PCB138}

Figuur \@ref(fig:zwevendPCBs) toont de jaarlijkse mediaan PCB138 per station voor de periode vanaf 1996 t/m `r dataJaar`, samen met de 10- en 90-percentiele waarde per jaar. Daarnaast zijn in Tabel \@ref(tab:zwevendPCBsTab) de mediane, 10- en 90-percentiele waardes per station weergegeven. Voor beide stations constateren we een afnemende lineaire trend rond de 0,10 tot 0,59 $\mu$g/kg per jaar. Voor station Vlissingen is de correlatie coëfficient lager.

### PCB153 {#zwevend-PCB153}

Figuur \@ref(fig:zwevendPCBs) toont de jaarlijkse mediaan PCB153 per station voor de periode vanaf 1996 t/m `r dataJaar`, samen met de 10- en 90-percentiele waarde per jaar. Daarnaast zijn in Tabel \@ref(tab:zwevendPCBsTab) de mediane, 10- en 90-percentiele waardes per station weergegeven. 

...
plotWeightedMeanMap(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s")
```
...
#plotCDF(df, "TM02: Golfperiode berekend uit het spectrum in s")
#plotCDF(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s")
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Deurloo (DEUR)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Cadzand (CADW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Wielingen (WIEL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Hoofdplaat (HFPL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Honte (HNTE)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Pas van Terneuzen (PVT)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Overloop van Hansweert (OVHW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Hansweert (HAWI)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Overloop van Valkenisse (OVVA)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s","TM02: Golfperiode berekend uit het spectrum in s"), "Bath (BAT2)")
```

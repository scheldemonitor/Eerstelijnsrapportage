...
refreshWaterstanden = !refreshData
refreshGolven = !refreshData
...
De fase van de M2-component hangt af van de positie in het estuarium, door de looptijd van het getij daar doorheen. De M2 fase is in de loop van de jaren 1998-`r dataJaar` niet veel veranderd.
...
Over de getoonde periode (1998-`r dataJaar`) neemt de fase van de M4-component bij Hansweert en bij Bath iets af. Voor de overige stations is de fase gelijk over dze periode.
...
if(refreshGolven){
  source("r/refresh_data.R") 
  refresh_golven(startjaar = 2018, datajaar = dataJaar)
}
```

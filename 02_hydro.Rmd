...
TH3 <- stationWeightedMean(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s") %>%
  select(Station, `Th3 med` = Gemiddelde)
TH3max <- stationMax(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in s") %>%
  select(Station, `Th3 max` = Max)
TM02 <- stationWeightedMean(df, "TM02: Golfperiode berekend uit het spectrum in s") %>%
  select(Station, `Tm02 med` = Gemiddelde)
TM02max <- stationMax(df, "TM02: Golfperiode berekend uit het spectrum in s") %>%

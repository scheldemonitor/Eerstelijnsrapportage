...
frozendatapath <- "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Data/yearly_golven_new"
pattern <- ".csv" # of iets anders wat de files karakteriseert die je wilt samenvoegen

allFiles <- list.files(file.path(frozendatapath), pattern = pattern, full.names = T)
...
GGH <- stationMedian(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm")
GGHmax <- stationMax(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm")
H3 <- stationMedian(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm")
H3max <- stationMax(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm")
dt <- data.frame("Station" = GGH$Station, "Hm0 mediaan" = GGH$Mediaan, "Hm0 maximum" = GGHmax$Max, "H1/3 mediaan" = H3$Mediaan, "H1/3 maximum" = H3max$Max)
knitr::kable(dt, 
             align = 'c',
             caption = "Gemiddelde en maximale waardes voor de golfperiode (zowel $H_{1/3}$ als  $H_{m0}$) voor alle stations.")
```
...
plotMedianMap(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm")
```
...
TH3 <- stationMedian(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
TH3max <- stationMax(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
TM02<- stationMedian(df, "TM02: Golfperiode berekend uit het spectrum in 0.1 s")
TM02max <- stationMax(df, "TM02: Golfperiode berekend uit het spectrum in 0.1 s")
dt <- data.frame("Station" = TH3$Station, "TH3 mediaan" = TH3$Mediaan, "TH3 maximum" = TH3max$Max, "Tm02 mediaan" = TM02$Mediaan, "Tm02 maximum" = TM02max$Max)
knitr::kable(dt, 
             align = 'c',
             caption = "Gemiddelde en maximale waardes voor de golfperiode (zowel $T_{H,1/3}$ als $T_{m02}$) voor alle stations.")
```
...
plotMedianMap(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
```

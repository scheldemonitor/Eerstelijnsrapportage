...
if(refresh) refresh_waterstanden(base_path = savepath, datajaar = 2020)
...
frozendatapath <- file.path(datapath, "Data_Hydro_1950_2020_new.csv")
...
frozendatapath <- file.path(datapath, "Data_Hydro_Golven_1998_2020.csv")

...
trendstations <- c("Bath (BAT2)","Hansweert (HAWI)","Cadzand (CAWI)","Cadzand (CADW)","Overloop van Hansweert (OVHW)","Deurloo (DELO)","Honte (HNTE)","Hoofdplaat (HFPL)","Overloop van Valkenisse (OVVA)","Pas van Terneuzen (PVT)","Wielingen (WIEL)")
...
frozendatapath <- "c:\\Users\\ronge_bb\\work\\R\\Data\\download\\Data_Hydro_Golven_1985_2020.csv"
...
#plotTrendsGolven(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm", "Deurloo (DELO)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Cadzand (CADW)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Wielingen (WIEL)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Hoofdplaat (HFPL)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Honte (HNTE)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Pas van Terneuzen (PVT)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Overloop van Hansweert (OVHW)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Hansweert (HAWI)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Overloop van Valkenisse (OVVA)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","GGH: Gemiddelde golfhoogte in cm"), "Bath (BAT2)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Cadzand (CADW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Wielingen (WIEL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Hoofdplaat (HFPL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Honte (HNTE)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Pas van Terneuzen (PVT)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Overloop van Hansweert (OVHW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Hansweert (HAWI)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Overloop van Valkenisse (OVVA)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Periodeparameter berekend uit het spectrum 0.03-0.5 Hz in 0.1 s"), "Bath (BAT2)")
```

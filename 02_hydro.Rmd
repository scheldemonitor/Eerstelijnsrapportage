...
trendstations <- c("Europlatform","Euro Platform","Vlakte van de Raan","Cadzand","Westkapelle","Breskens Veerhaven","Vlissingen","Gat van Borssele","Overloop van Hansweert", "Terneuzen", "Hansweert", "Walsoorden", "Baalhoek", "Schaar van de Noord", "Bath")

frozendatapath <- "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Data/Data_Hydro_1950_2020_new.csv"
...
plotTrendsWaterstand(df, c("Hoogwater in cm+NAP","Laagwater in cm+NAP"), "Euro Platform")
```
...
```{r hydroGetijslag, fig.height=8, out.height="600px", fig.cap="De mediaan van getijslag over tijd op de Noordzee, in de monding en in de Westerschelde. Dunnere en transparante kleuren geven jaarlijkse gemiddeldes aan met twee of meer maanden met missende data."}
...
values = df2 %>% #st_drop_geometry() %>%
  filter(parametername == "Getijslag in cm") %>%
...
df2 %>% #st_drop_geometry() %>%
  ...
  leaflet() %>%
  addTiles() %>%
  addCircleMarkers(fillColor = ~pal(Mediaan), fillOpacity = 1, stroke = F, label = ~paste(Station, signif(Mediaan, 2), "Getijslag in cm")) %>%
...
p <- plotTrendsByLocationClass(df, "Fase (g) in graden tov MET", "COMP 113 M4")
p$layers[[2]] <- NULL # remove dots
ggplotly(p)
```
...
frozendatapath <- "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Data/Data_Hydro_Golven_1998_2020"
```

```{r downloadHydroGolven, include = F, eval = F}
datapathin <- "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Data/yearly_golven_new"
allFiles <- list.files(file.path(datapathin), pattern = ".csv", full.names = T)
df <- lapply(
...
ggsave(cdf_H3, filename = "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Figuren/cdf_H3.png")
cdf_th3 <- plotCDF(df,"TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
ggsave(cdf_th3, filename =  "n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Figuren/cdf_TH3.png")
...
write_delim(df, frozendatapath, delim = ",")
```
...
GGH <- stationWeightedMean(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm") %>%
  select(Station, `Hm0 mediaan` = Gemiddelde)
GGHmax <- stationMax(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm") %>%
  select(Station, `Hm0 maximum` = Max)
H3 <- stationWeightedMean(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm") %>%
  select(Station, `H1/3 mediaan` = Gemiddelde)
H3max <- stationMax(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm") %>%
  select(Station, `H1/3 maximum` = Max)
dt = full_join(GGH, GGHmax) %>% full_join(H3) %>% full_join(H3max)
knitr::kable(dt, 
             align = 'c',
             caption = "Gewogen gemiddelde en maximale waardes voor de golfperiode (zowel $H_{1/3}$ als  $H_{m0}$) voor alle stations.")
```
...
#plotMedianMap(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm")
plotWeightedMeanMap(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm")
```
...
#plotCDF(df, "Hm0: Significante golfhoogte uit 10mHz spectrum in cm")
#plotCDF(df, "H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm")
knitr::include_graphics("n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Figuren/cdf_H3.png")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Deurloo (DEUR)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Cadzand (CADW)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Wielingen (WIEL)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Hoofdplaat (HFPL)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Honte (HNTE)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Pas van Terneuzen (PVT)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Overloop van Hansweert (OVHW)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Hansweert (HAWI)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Overloop van Valkenisse (OVVA)")
```
...
plotTrendsGolven(df, c("H3: Gemiddelde hoogte van het 1/3 deel hoogste golven in cm","Hm0: Significante golfhoogte uit 10mHz spectrum in cm"), "Bath (BAT2)")
```
...
TH3 <- stationWeightedMean(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s") %>%
  select(Station, `Th3 mediaan` = Gemiddelde)
TH3max <- stationMax(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s") %>%
  select(Station, `Th3 maximum` = Max)
TM02 <- stationWeightedMean(df, "TM02: Golfperiode berekend uit het spectrum in 0.1 s") %>%
  select(Station, `Tm02 mediaan` = Gemiddelde)
TM02max <- stationMax(df, "TM02: Golfperiode berekend uit het spectrum in 0.1 s") %>%
  select(Station, `Tm02 maximum` = Max)
dt = full_join(TH3, TH3max) %>% full_join(TM02) %>% full_join(TM02max)
knitr::kable(dt, 
             align = 'c',
             caption = "Gewogen gemiddelde en maximale waardes voor de golfperiode (zowel $T_{H,1/3}$ als $T_{m02}$) voor alle stations.")
```
...
plotWeightedMeanMap(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
```
...
#plotCDF(df, "TM02: Golfperiode berekend uit het spectrum in 0.1 s")
#plotCDF(df, "TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s")
knitr::include_graphics("n:/Projects/1209000/1209394/C. Report - advise/Eerstelijnsrapportage/2021/Figuren/cdf_TH3.png")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Deurloo (DEUR)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Cadzand (CADW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Wielingen (WIEL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Hoofdplaat (HFPL)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Honte (HNTE)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Pas van Terneuzen (PVT)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Overloop van Hansweert (OVHW)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Hansweert (HAWI)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Overloop van Valkenisse (OVVA)")
```
...
plotTrendsGolven(df, c("TH3: Gemiddelde periode van de golven waaruit H3 bepaald is in 0.1 s","TM02: Golfperiode berekend uit het spectrum in 0.1 s"), "Bath (BAT2)")
```
